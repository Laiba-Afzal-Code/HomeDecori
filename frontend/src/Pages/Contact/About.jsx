      ...
      <div className="about-page">
        ...
        <section className="about-content">
          <div className="about-text">
            ...
            <p>
              HomeDecorim is a design-focused blog and creative platform
              dedicated to home styling, interior inspiration, and modern decor
              trends. We help homeowners, designers, and brands create
              meaningful spaces that reflect lifestyle and personality.
            </p>
          </div>
        ...
        <div className="about-page">
          ...
          <section className="about-section">
            <div className="about-container">
              <h2 className="abouth2">Who We Are</h2>
              <p>
                Our platform was created to provide a professional online text
                editor that combines simplicity with powerful features. Whether
                you're a student, writer, developer, or professional, our editor
                helps you write, edit, format, and export your content with
                ease.
              </p>
            </div>
          </section>
          ...
          <section className="about-footer">
            ...
            <p className="porp">
              We are committed to continuous innovation, performance
              optimization, and delivering secure, reliable tools that enhance
              your productivity.
            </p>
          </section>
        </div>
        ...
        <section className="about-cards">
          <div className="about-card">
            ...
            <p>
              Curated content covering interior design trends, DIY ideas, space
              planning, and modern living inspiration.
            </p>
          </div>
          ...
          <div className="about-card">
            ...
            <p>
              Professional social media management, content creation, and
              audience engagement for lifestyle and decor brands.
            </p>
          </div>
        </section>
        ...
        <section className="about-social">
          ...
          <p>
            We actively share ideas, visuals, and insights across social
            platforms to inspire design-driven communities.
          </p>

          <div className="social-links">
            <a
              href="https://www.instagram.com/home_decorim"
              target="_blank"
              rel="noreferrer"
            >
              Instagram
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61582429130428"
              target="_blank"
              rel="noreferrer"
            >
              Facebook
            ...
            <a
              href="https://www.linkedin.com/showcase/homedecorim/"
              target="_blank"
              rel="noreferrer"
            >
              LinkedIn
